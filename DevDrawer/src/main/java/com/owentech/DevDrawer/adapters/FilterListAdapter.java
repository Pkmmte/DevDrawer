...
public class FilterListAdapter extends RecyclerView.Adapter<FilterListAdapter.ListItemViewHolder> {
    ...
    public void onBindViewHolder(ListItemViewHolder viewHolder, final int position) {
        ...
        viewHolder.deleteButton.setImageDrawable(AppWidgetUtil.getColoredDrawable(activity, R.drawable.trash, activity.getResources().getColor(R.color.primaryDark)));
        viewHolder.editButton.setImageDrawable(AppWidgetUtil.getColoredDrawable(activity, R.drawable.edit, activity.getResources().getColor(R.color.primaryDark)));
